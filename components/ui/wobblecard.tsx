...
export const WobbleCard = ({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "relative w-full overflow-hidden rounded-2xl bg-indigo-800",
        containerClassName,
      )}
    >
      <div
...
const Noise = () => {
  return (
    <div
      className="absolute inset-0 size-full scale-[1.2] transform opacity-10 [mask-image:radial-gradient(#fff,transparent,75%)]"
      style={{
